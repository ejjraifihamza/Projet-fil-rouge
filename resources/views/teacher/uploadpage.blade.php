...
<body>
    ...
    <input type="text" required name="name" placeholder="Homework name" class="block shadow-5xl mb-5 p-2 w-80 italic
    ...
    <input type="text" required name="description" placeholder="Homework discription" class="block shadow-5xl mb-5 p-2 w-80 italic
    placeholder-gray-400 w-full">
    <label class="block uppercase tracking-wide text-gray-700 text-xl font-bold mb-2">Deadline</label>
    <input type="date" required name="deadline" class="block shadow-5xl mb-5 p-2 w-80 italic
    placeholder-gray-400 w-full">
