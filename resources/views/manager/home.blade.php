    ...
    <div class="flex items-center justify-center">
        <div class="bg-gray-100 w-7/12 mt-10 rounded-lg py-10 shadow-xl">
            <div class="flex items-center justify-center pt-5 flex-col">
                <div class="px-4 py-2 mb-4 text-sm font-semibold bg-transparent rounded-lg md:mt-0 md:ml-4 hover:text-gray-900 focus:text-gray-900 hover:bg-blue-500 focus:bg-gray-200 focus:outline-none focus:shadow-outline bg-blue-400">
