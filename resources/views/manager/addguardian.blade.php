...
<body>
    ...
    <form action="{{ route('manager.uploadguardian') }}" method="post">
    @csrf
    ...
    placeholder-gray-400">
    <label for="class_name" class="block uppercase tracking-wide text-gray-700 text-xl font-bold mb-2">Choose a student:</label>
    <select id="grid-state" required id="class" name="user_id" class="block shadow-5xl mb-5 p-2 w-80 italic
    placeholder-gray-400">
